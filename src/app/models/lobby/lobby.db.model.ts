...
export class LobbyDb{
	...
	private _members:Array<MemberDb|string>;
	...
	public get members():Array<MemberDb|string>{return this._members;}
	public set members(members:Array<MemberDb|string>){this._members = members;}
}
